...
class NewAccountForm(FlaskForm):
    username = EmailField('Email address:', [validators.DataRequired(), validators.Email()], render_kw={"class": "form-control"})
    password = PasswordField("Password:", [validators.DataRequired()], render_kw={"class": "form-control"})
    firstname = StringField("First name:",[validators.DataRequired()], render_kw={"class": "form-control"})
    lastname = StringField("Last name:",[validators.DataRequired()], render_kw={"class": "form-control"})
